...
ACQUISTI (flusso costi):
  ...
  PRIORITA' 2 — ANALISI CONTENUTO FATTURA IN 4 PASSI:
    PASSO 1: Leggi attentamente TUTTE le righe di descrizione prodotti/servizi.
             ...
             elettricita', gas, acqua, manutenzione O un'attrezzatura nella stessa fattura.
    ...
    PASSO 2: Determina la NATURA del bene/servizio:
             ...
             ATTENZIONE FORNITORI MULTI-SERVIZIO:
             Questi fornitori possono addebitare in una sola fattura piu articoli/prodotti.
             Leggi OGNI RIGA e assegna il conto corretto in base al CONTENUTO, non al nome fornitore.
...
"""
    ...
    for risultato in risultati:
        ...
        for i_reg, reg in enumerate(registrazioni):
            ...
            # Traccia fornitore, numero fattura e data principale
            ...
            # Memorizza l'ultima data valida per la riga separatrice
        ...
        # ── Riga separatrice con data (per preservare ordinamento cronologico) ──
        if riga:
            riga_sep = {col: None for col in riga.keys()}
            riga_sep["Data"] = ultima_data_fattura   # stessa data fattura, nient'altro
...
def formatta_df_per_export(df: pd.DataFrame, destinazione: str) -> pd.DataFrame:
    ...
    # Rimuovi colonne interne prima dell'export
